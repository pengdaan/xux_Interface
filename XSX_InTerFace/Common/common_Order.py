...
class order:
    ...
    def reateOrderTour(self):
        '''旅游创建订单'''
        api_secrets= XSX_InTerFace.Common.All_secrets.ly_secrets
    ...
    def updatePayDPStatu(self,status=None,ly_order=None,DP_order=None):
        ...
        #小树熊订单
            ...
            payloads.setdefault('order_sn',order_sns) #插入订单号
            api_secrets= XSX_InTerFace.Common.All_secrets.update_dpStatus#返回api_secret
            payload=payloads
            api_sign= XSX_InTerFace.Setting.api_signs.api_signs(payload,api_secrets)
            payload.setdefault('api_sign',api_sign)
            requests.post(common_data.updatePayStatus_url, params=payload)
        ...
        #旅游订单'
            ...
            print ly_order,'入参'
            api_sign= XSX_InTerFace.Setting.api_signs.api_signs(ly_order,api_secrets)
