...
def shipw_data():
    ...
    api_sign= XSX_InTerFace.Setting.api_signs.api_signs(PayStatus_ly, XSX_InTerFace.Common.All_secrets.www_secrets)
    PayStatus_ly.setdefault('api_sign',api_sign)
    requests.post(XSX_InTerFace.Common.common_data.updatePayStatus_url, params=PayStatus_ly)
    print PayStatus_ly
...
def ship_data():
    ...
    PayStatus_ly.setdefault('api_sign',api_sign)
    requests.post(XSX_InTerFace.Common.common_data.updatePayStatus_url, params=PayStatus_ly)
    api_sign_data= XSX_InTerFace.Setting.api_signs.api_signs(ship_data, XSX_InTerFace.Common.All_secrets.www_secrets)
