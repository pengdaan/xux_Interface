...
import time
import XSX_InTerFace.XUX_Pms.test_data
...
class Test(XSX_InTerFace.XUX_Pms.interface_pms.MyTest):
    ...
    def test_Pmsadd_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.test_Addpms
    ...
    def test_Pmsoperate_sucess(self):
        '''Pms操作优惠活动（开启、关闭）接口'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.test_Pmsoperate
    ...
    def test_createDepositMission_sucess(self):
        '''添加定金团活动'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.CreateDepositMission_data
    ...
    def test_updateDepositMission_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.updateDepositMission_data(id,Title,startAt,endAt,fromAt,toAt)
    ...
    def test_createWithGoods_sucess(self):
        '''添加拼货团'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.createWithGoods_data
        CreateDepositMission=XSX_InTerFace.Common.XSX_Driver.XsxDriver()
    ...
    def test_createActivityAll_sucess(self):
        '''添加专享活动_all'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.createActivityAll_data
        CreateDepositMission=XSX_InTerFace.Common.XSX_Driver.XsxDriver()
    ...
    def test_createActivityLF_sucess(self):
        '''添加专享活动_良粉'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.createActivityLF_data
    ...
    def test_createActivity3month_sucess(self):
        '''添加专享活动_3个月没购买行为'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.createActivity3month_data
        createActivityLF=XSX_InTerFace.Common.XSX_Driver.XsxDriver()
    ...
    def test_createActivityNew_sucess(self):
        '''添加限时专享_妈妈良品新客'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.createActivityNew_data
        createActivityLF=XSX_InTerFace.Common.XSX_Driver.XsxDriver()
        createActivityLF.send_data(Test_data,self.createActivityAll_Url ,api_secrets)
    ...
    def test_createActivityNews_sucess(self):
        '''添加限时专享_妈妈良品新会员'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.createActivityNews_data
        createActivityLF=XSX_InTerFace.Common.XSX_Driver.XsxDriver()
        createActivityLF.send_data(Test_data,self.createActivityAll_Url ,api_secrets)
    ...
    def test_fullcutPromotion_sucess(self):
        '''添满减满赠活动_满减'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.fullcutPromotion_data
    ...
    def test_fullcutPromotionZ_sucess(self):
        '''添满减满赠活动_满赠'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.fullcutPromotionZ_data
        fullcutPromotion=XSX_InTerFace.Common.XSX_Driver.XsxDriver()
        fullcutPromotion.send_data(Test_data, self.fullcutPromotionUrl ,api_secrets)
    ...
    def test_confict_sucess(self):
        '''添加预售商品活动'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.confict_data
    ...
    def test_MS_save_sucess(self):
        '''添加秒杀活动'''
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        Test_data=XSX_InTerFace.XUX_Pms.test_data.MS_save_data
        confict=XSX_InTerFace.Common.XSX_Driver.XsxDriver()
    ...
    def test_MS_Goods_sucess(self):
        ...
        MS_Goods_data=XSX_InTerFace.XUX_Pms.test_data.MSgoods_data(MSId)
    ...
    def test_NameRepeat_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.NameRepeat_data
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
    ...
    def test_Pmssend_sucess(self):
        ...
        api_secrets=XSX_InTerFace.Common.All_secrets.pms_secrets
        AddPms_data=XSX_InTerFace.XUX_Pms.test_data.test_Addpms
        print AddPms_data
        ...
        #print PmsId
        Test_data=XSX_InTerFace.XUX_Pms.test_data.Pmssend_data(PmsId)
        #print Test_data
    ...
    def test_batchSend_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.BatchSend_data(PmsId)
    ...
    def test_Pmsinfo_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.Pmsinfo_data
    ...
    def test_PcodeList_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.pcodeList_data
    ...
    def test_listGoodsPromotion_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.listGoodsPromotion_data
    ...
    def test_Pmsupdate_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.Pms_updateStatus(promotion_code)
    ...
    def test_redemption_sucess(self):
        ...
        Test_data=XSX_InTerFace.XUX_Pms.test_data.redemption_data
