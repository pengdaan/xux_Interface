...
def shipw_data():
    ...
    api_sign= xux_Interface.setting.api_signs.api_signs(PayStatus_ly, xux_Interface.all_secrets.www_secrets)
    PayStatus_ly.setdefault('api_sign',api_sign)
    requests.post(xux_Interface.common.common_data.updatePayStatus_url, params=PayStatus_ly)
    print PayStatus_ly
...
def ship_data():
    ...
    PayStatus_ly.setdefault('api_sign',api_sign)
    requests.post(xux_Interface.common.common_data.updatePayStatus_url, params=PayStatus_ly)
    api_sign_data= xux_Interface.setting.api_signs.api_signs(ship_data, xux_Interface.all_secrets.www_secrets)
