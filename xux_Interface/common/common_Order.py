...
class order:
    ...
    def reateOrderTour(self):
        '''旅游创建订单'''
        api_secrets= xux_Interface.all_secrets.ly_secrets
    ...
    def orderDP(self,order_data=None):
        ...
        api_secrets= xux_Interface.all_secrets.dp_secrets
        payload=order_data
        api_sign= xux_Interface.setting.api_signs.api_signs(payload,api_secrets)
        payload.setdefault('api_sign',api_sign)
        #print payload
    ...
    def Pmsadd(self):
        '''Pms添加优惠劵'''
        api_secrets= xux_Interface.all_secrets.pms_secrets
    ...
    def updatePayDPStatu(self,status=None,ly_order=None,DP_order=None):
        '''更新订单支付状态'''
        api_secrets= xux_Interface.all_secrets.update_dpStatus
        ...
        #小树熊订单
            ...
            payloads.setdefault('order_sn',order_sns) #插入订单号
            api_secrets= xux_Interface.all_secrets.update_dpStatus#返回api_secret
            payload=payloads
            api_sign= xux_Interface.setting.api_signs.api_signs(payload,api_secrets)
            payload.setdefault('api_sign',api_sign)
            requests.post(common_data.updatePayStatus_url, params=payload)
        ...
        #旅游订单'
            ...
            print ly_order,'入参'
            api_sign= xux_Interface.setting.api_signs.api_signs(ly_order,api_secrets)
