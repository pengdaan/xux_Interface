...
import datetime
times= int(time.time())
createOrderTour_url='http://XUX_www.xiaoshuxiong.com/api/XUX_OrderApi/createOrderTour'
updatePayStatus_url='http://XUX_www.xiaoshuxiong.com/api/XUX_OrderApi/updatePayStatus'
orderDP_url="http://XUX_www.xiaoshuxiong.com/api/XUX_OrderApi/createOrderDp"
orderXUX_url="http://XUX_OrderApi.api.xiaoshuxiong.com/Order/createOrderXsx"
PMSadd_url="http://XUX_Pms.api.xiaoshuxiong.com/pmsapi/action/promotion/add"
BatchSend_url='http://XUX_Pms.api.xiaoshuxiong.com/pmsapi/action/promotion/code/batchSend'
